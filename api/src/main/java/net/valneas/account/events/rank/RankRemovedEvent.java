...
public class RankRemovedEvent<T> {
    ...
    public RankRemovedEvent(AccountManager<? extends AbstractAccount, ? extends RankManager<? extends RankUnit>> accountManager, int rankId, T sender) {
