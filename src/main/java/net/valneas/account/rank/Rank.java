...
public class Rank {
    ...
    public void setMajorRank(RankUnit rank, CommandSender sender, boolean event){
        if(rank == null) {
            return;
    ...
    public void addRank(RankUnit rank, CommandSender sender, boolean event){
        if (rank == null) {
            return;
        }else if (!accountManager.hasAnAccount()) {
            return;
    ...
    public void removeRank(RankUnit rank, CommandSender sender, boolean event){
        if (rank == null) {
            return;
        }else if (!accountManager.hasAnAccount()) {
            return;
